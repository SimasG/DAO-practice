...
// ** Is this simplistic contract enough to simulate an NFT marketplace?
// ** We should also auto generate some NFTs available for purchase, no?
contract FakeNFTMarketplace {
    /// @dev Maintain a mapping of Fake TokenID to Owner addresses
    mapping(uint256 => address) public tokens;
    /// @dev Set the purchase price for each Fake NFT
    // ** No `private constant` keyword since we're using a getter for the value?
